...
async function main() {
    console.log("=== Manual 2-Loop Leverage Test ===\n");
    ...
    const initialAmount = hre.ethers.parseEther("0.3");
    ...
    for (let loop = 1; loop <= 2; loop++) {
        ...
        // Convert from base currency to IP
    ...
    console.log("=== Final Position (After 2 Loops) ===");
